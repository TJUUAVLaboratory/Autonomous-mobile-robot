...
#include "cartographer_ros_msgs/lidarpose.h"
...
class Node {
 public:
  ...
  void LoadState(const std::string& state_filename, bool load_frozen_state,std::string lanmark_poses_file = "n");
 ...
 private:
  ...
  void PublishLocalOccupancyGrid(const ::ros::WallTimerEvent& unused_timer_event);
  ...
  ::ros::Publisher local_occupancy_grid_publisher_;
