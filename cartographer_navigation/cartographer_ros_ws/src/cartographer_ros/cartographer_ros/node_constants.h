...
constexpr char kLocalOccupancyGridTopic[] = "local_map";
constexpr char kSubmapQueryServiceName[] = "submap_query";
constexpr char kPoseQueryServiceName[] = "pose_query";
constexpr char kSaveMapServiceName[] = "map_save";
constexpr char kSaveFenceServiceName[] = "save_fence";
